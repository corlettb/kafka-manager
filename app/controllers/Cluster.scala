    ...
    mapping(
      ...
      , "tuning" -> optional(
        mapping(
          ...
          , "clusterManagerThreadPoolQueueSize" -> optional(number(10, 100000))
          , "kafkaCommandThreadPoolSize" -> optional(number(2, 1000))
          , "kafkaCommandThreadPoolQueueSize" -> optional(number(10, 100000))
          , "logkafkaCommandThreadPoolSize" -> optional(number(2, 1000))
          , "logkafkaCommandThreadPoolQueueSize" -> optional(number(10, 100000))
          ...
          , "brokerViewThreadPoolQueueSize" -> optional(number(10, 100000))
          , "offsetCacheThreadPoolSize" -> optional(number(2, 1000))
          , "offsetCacheThreadPoolQueueSize" -> optional(number(10, 100000))
          , "kafkaAdminClientThreadPoolSize" -> optional(number(2, 1000))
          , "kafkaAdminClientThreadPoolQueueSize" -> optional(number(10, 100000))
